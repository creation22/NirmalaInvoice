...
export const WIZARD_STEPS: WizardStepDef[] = [
    ...
    },
    {
        ...
        requiredFields: [
            ...
            "details.paymentInformation.upiEnabled",
            "details.paymentInformation.upiId",
        ],
...
export const PAYMENT_STEP_ID = 3;
export const isPaymentStep = (id: number) => id === PAYMENT_STEP_ID;
